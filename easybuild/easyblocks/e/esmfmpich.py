...
Edited for MPICH by Tor Skovsgaard (DeiC/LUMI User Support Team)
"""
import os
...
class esmfmpich(ConfigureMake):
    ...
    def sanity_check_step(self):
        ...
        super(esmfmpich, self).sanity_check_step(custom_paths=custom_paths)
